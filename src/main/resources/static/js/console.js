...
layui.use(["okUtils", "table", "okCountUp", "okMock"], function () {
    ...
    var userSourceOption = {
        ...
        "series": [
            ...
            {"name": "就业人数", "type": "line", "stack": "总量", "label": {"normal": {"show": true, "position": "top"}}, "areaStyle": {"normal": {}}, "data": [820, 932, 901, 934, 1290, 1330, 1320]}
        ]
    };
     ...
     */
    function userSource() {
        okUtils.ajax("/employ/count").done(function (response) {
            if(response.code == 0){
                debugger
                userSourceOption.xAxis[0].data = response.data.stringList;
                userSourceOption.series[0].data = response.data.integerList;
            }
