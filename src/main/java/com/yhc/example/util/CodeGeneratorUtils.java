...
public class CodeGeneratorUtils {
    ...
    private static final String AUTHOR = "yanghc";
    private static final String HOST = "127.0.0.1";
    private static final String DRIVER_CLASS_NAME = "com.mysql.cj.jdbc.Driver";
    private static final String DATABASE_NAME = "scan";
    private static final String DATABASE_USERNAME = "yhc_db";
    private static final String DATABASE_PASSWORD = "123456";
    private static final String PARENT_PACKAGE = "com.talkweb.scan.mater";
